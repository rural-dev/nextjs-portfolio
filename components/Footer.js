        ...
        <div className="bg-bg2 flex lg:flex-row flex-col py-16 px-5 lg:px-20">
            ...
            <div className="lg:basis-3/5 basis-5/5 ml-auto rounded-md flex flex-col p-8 bg-gradient-to-r from-[#FFFFFF10] to-transparent">
              <form ref={form} onSubmit={sendEmail}>
                  <input type="text" id="from_name" name="from_name" className="w-full bg-transparent border-b-[1px] border-white mb-4 py-2 px-2 text-white text-sm font-medium font-body" placeholder="Your name"></input>
                  <input type="text" id="from_email" name="from_email" className="w-full bg-transparent border-b-[1px] border-white mb-4 py-2 px-2 text-white text-sm font-medium font-body" placeholder="Your email"></input>
                  <input type="text" id="message" name="message" className="w-full h-[80px] bg-transparent border-b-[1px] border-white pt-2 px-2 pb-auto text-white text-sm font-medium font-body" placeholder="Your project description"></input>
