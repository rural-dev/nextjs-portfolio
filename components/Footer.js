      ...
      <div className="relative" id="contact">
        <div className="bg-bg2 flex lg:flex-row flex-col py-16 px-5 lg:px-20">
            <div className="lg:basis-2/5 basis-5/5 flex flex-col px-5 lg:px-0 pb-10 lg:pb-0">
                ...
                <a href="https://www.upwork.com/freelancers/~018467d55c4bde0a45" target='_blank' rel="noreferrer"><p className="text-white text-lg font-semibold font-body">Hire me on Upwork</p></a>
